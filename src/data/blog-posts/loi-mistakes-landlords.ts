...
export const post: BlogPost = {
  slug: "loi-mistakes-landlords",
  title: "10 LOI Mistakes That Cost Landlords Thousands",
  metaDescription: "Avoid these 10 costly LOI mistakes that landlords make in commercial real estate. Each one has real dollar consequences and a clear fix.",
  category: "Negotiation Strategy",
  publishedDate: "2026-03-13",
  relatedSlugs: ["loi-checklist-provisions", "security-deposit-negotiation", "cam-clauses-loi"],
  faqs: [
    {
      question: "What is the most expensive LOI mistake landlords make?",
      answer: "The most financially damaging mistake is typically accepting below-market rent escalations. A landlord who agrees to 2% annual increases when the market supports 3% will lose tens of thousands of dollars over a 10-year lease due to compounding. On a 5,000-square-foot space at $30 per square foot, that 1% gap compounds to over $47,000 in lost revenue across the full term. Unlike a one-time concession, escalation shortfalls grow every year."
    },
    {
...
Here are the 10 most common LOI mistakes we see landlords make, along with the specific dollar impact and the fix for each one. For a complete list of what every LOI should include, see the [LOI provisions checklist](/blog/loi-checklist-provisions).

## Mistake 1: Missing Holdover Clause

### The Problem

The LOI says nothing about what happens when the tenant remains in the space after the lease expires. Without a [holdover](/glossary#holdover) provision in the LOI, the landlord's attorney may include one in the lease, but by then the tenant's counsel will push back hard. If the lease is ultimately silent on holdover, most states default to a month-to-month tenancy at the existing rent.
...
The LOI specifies a [security deposit](/glossary#security-deposit) of one month's base rent for a local tenant with no established operating history. One month of base rent provides almost no meaningful protection if the tenant defaults.
...
The LOI states that the tenant will pay "their pro rata share of [CAM](/glossary#cam) charges" without defining what is included, what is excluded, or whether there is an annual cap. This gives the tenant's attorney room to negotiate narrow CAM definitions in the lease that exclude significant expense categories.
...
Specify in the LOI that CAM charges include all operating expenses, management fees (typically 3% to 5% of gross revenue), capital expenditure reserves, and insurance. If you are willing to offer a CAM cap, state the specific cap percentage, such as a 5% annual increase over the base year. For a deeper dive into structuring CAM provisions, see [CAM Clauses in LOIs](/blog/cam-clauses-loi).
...
Across a portfolio, these numbers compound rapidly. A landlord managing 25 retail and office leases who consistently overlooks [holdover](/glossary#holdover), [CAM](/glossary#cam), and escalation provisions may be underperforming by $200,000 to $500,000 annually without realizing it.

## How to Avoid These Mistakes

### Systematize Your LOI Review Process

Do not rely on instinct or experience alone. Use a standardized checklist that covers all 15 critical provision categories. Run every LOI through the same process regardless of deal size. The [LOI provisions checklist](/blog/loi-checklist-provisions) is a good starting point.

### Benchmark Every Term Against Market Data

Every provision in your LOI should be supportable with market data. What is the standard [security deposit](/glossary#security-deposit) for this tenant profile? What escalation rate are comparable properties achieving? What CAM recovery percentage are other landlords getting? Without benchmarks, you are guessing.
