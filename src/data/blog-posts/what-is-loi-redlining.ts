...
export const post: BlogPost = {
  slug: "what-is-loi-redlining",
  title: "What is LOI Redlining in Commercial Real Estate?",
  metaDescription: "Learn what LOI redlining means in CRE, why it matters, the step-by-step process, and how AI is transforming lease negotiation.",
  category: "LOI Basics",
  publishedDate: "2026-03-10",
  relatedSlugs: ["loi-checklist-provisions", "loi-vs-lease-differences", "loi-mistakes-landlords"],
  faqs: [
    {
      question: "What does it mean to redline an LOI?",
      answer: "Redlining an LOI means reviewing a Letter of Intent for a commercial real estate lease and marking proposed changes, additions, or deletions. The term comes from the traditional practice of using red ink to annotate suggested edits. Modern redlining involves analyzing each provision against market standards and flagging terms that need negotiation."
    },
    {
    ...
    },
    {
      ...
      answer: "Typically the party that receives the LOI performs the initial redline. If the landlord sends the LOI, the tenant's team redlines it and returns proposed changes. However, landlords benefit from redlining their own LOI before sending it to identify weaknesses and strengthen their position proactively."
    }
  ],
  content: `## What is a Letter of Intent?

A [Letter of Intent](/glossary#loi), commonly called an LOI, is the opening document in virtually every commercial real estate lease negotiation. It outlines the principal business terms that both parties agree to before anyone spends money on attorneys to draft a full lease. Think of it as the handshake that precedes the contract.
...
These three provisions are consistently the most overlooked in LOI redlining, and they are among the most financially significant. A missing or weak [holdover](/glossary#holdover) provision can cost a landlord tens of thousands in lost re-leasing opportunity. A permissive assignment clause can leave you with a tenant you never approved. And an uncapped [CAM](/glossary#cam) provision can increase a tenant's occupancy cost by 15% to 25% over the lease term.

Brokers frequently focus on the headline economics, base rent, TI allowance, and free rent, while treating operational provisions as details to work out later. That approach consistently produces worse outcomes. The [full provision checklist](/blog/loi-checklist-provisions) covers all 15 categories that deserve attention.
...
The most common [mistakes landlords make](/blog/loi-mistakes-landlords) during redlining include underestimating the cumulative impact of tenant concessions, failing to include operational provisions that protect the property, and rushing the review process to keep a deal moving. Speed is important, but not at the expense of a thorough analysis.

## When Should Tenants Redline?

Tenants should redline every LOI they receive, without exception. Even if the initial terms seem favorable, there are almost certainly provisions that benefit from negotiation. The [LOI checklist](/blog/loi-checklist-provisions) covers all 15 provision categories that tenants should review.
