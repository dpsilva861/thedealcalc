...
[Percentage rent](/glossary#percentage-rent) is more common in restaurant leases than in almost any other retail category. The typical structure for restaurants is 6% to 8% of gross sales above a natural breakpoint, with the breakpoint calculated by dividing the annual base rent by the percentage rate.
...
**Transfer and assignment.** A liquor license is typically tied to the specific operator and location. If the tenant assigns the lease, the new operator must obtain their own license. This is another reason to maintain tight control over [assignment and subletting rights](/blog/loi-mistakes-landlords), especially for restaurant tenants.
...
## Using the Right [Use Clause](/glossary#use-clause) Language
