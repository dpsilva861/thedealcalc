...
**Market standard.** Two months of base rent plus [NNN](/glossary#nnn) for local tenants, one month for national credit tenants. Letters of credit preferred for deposits above $25,000.
...
For a deep dive on deposit structuring, see our [Security Deposit Negotiation guide](/blog/security-deposit-negotiation).
...
**Market standard.** Full [NNN](/glossary#nnn) pass-through with a 10% to 15% administrative fee. [CAM](/glossary#cam) caps, if granted, should be 4% to 5% annually on controllable expenses only, with taxes and insurance always excluded from any cap.
...
See [CAM Clauses in LOIs](/blog/cam-clauses-loi) for detailed guidance on structuring these provisions.
...
**Market standard.** [Holdover](/glossary#holdover) rent at 150% of the then-current base rent plus all additional rent, on a month-to-month basis terminable by landlord on 30 days' notice. Tenant also liable for consequential damages if the holdover prevents landlord from delivering the space to a new tenant.
...
**What to look for.** Whether a [personal guaranty](/glossary#personal-guaranty) is required, who provides it, the amount, the duration, and the structure (full vs. limited vs. declining).
...
**What to look for.** [Right of first refusal](/glossary#rofr) on adjacent space, right of first offer, expansion options, and early termination rights.
