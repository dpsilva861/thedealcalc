...
export const post: BlogPost = {
  slug: "security-deposit-negotiation",
  title: "Security Deposit Negotiation: A Landlord's LOI Guide",
  metaDescription: "How to negotiate security deposits in commercial real estate LOIs. Covers cash vs letter of credit, burn-down schedules, and personal guaranties.",
  category: "Negotiation Strategy",
  publishedDate: "2026-03-15",
  relatedSlugs: ["loi-checklist-provisions", "loi-mistakes-landlords", "national-credit-vs-local-tenant"],
  faqs: [
    {
      question: "How much should a commercial landlord require for a security deposit?",
      answer: "The standard starting point is two months of base rent plus NNN charges for local tenants and new business entities. For national credit tenants with strong balance sheets, one month of base rent is typically sufficient. For higher-risk tenants, such as first-time operators, franchise entities with limited capitalization, or businesses in volatile industries, landlords should consider requiring three months or pairing a smaller deposit with a personal guaranty. The deposit amount should always reflect the landlord's total exposure, including unamortized concessions like free rent and tenant improvement allowances."
    },
    {
      question: "What is a burn-down schedule for a security deposit?",
      answer: "A burn-down schedule is a structured reduction of the security deposit over time, contingent on the tenant's payment history. A typical burn-down reduces the deposit by 25% to 50% after 36 months of on-time payment, with further reductions at 48 or 60 months. Burn-down provisions are a valuable negotiation tool because they give the tenant a financial incentive to maintain good standing while ensuring the landlord has maximum protection during the early years of the lease when default risk is highest."
    }
  ],
  content: `## Why the Security Deposit Deserves Attention at the LOI Stage

The [security deposit](/glossary#security-deposit) is one of the most negotiated provisions in any commercial lease, yet many landlords treat it as an afterthought at the LOI stage. They write "security deposit equal to one month's rent" and move on to the next provision.
...
For a complete overview of all provisions that deserve careful attention at the LOI stage, review the [LOI provisions checklist](/blog/loi-checklist-provisions). This guide focuses specifically on structuring and negotiating the security deposit.
...
A [letter of credit](/glossary#letter-of-credit) (LC) is a commitment from a bank to pay the landlord a specified amount upon presentation of required documents. The tenant pays the bank an annual fee, typically 1% to 3% of the LC face amount, to maintain the instrument.
...
For landlords who want to avoid the [costly mistakes](/blog/loi-mistakes-landlords) that come from vague or incomplete deposit language, this level of specificity at the LOI stage is not optional. It is essential.
