...
export const post: BlogPost = {
  slug: "national-credit-vs-local-tenant",
  title: "National Credit vs Local Tenant: How LOI Strategy Changes",
  metaDescription: "Learn how LOI negotiation strategy shifts between national credit tenants and local operators. Covers deposits, guaranties, and deal traps.",
  category: "Negotiation Strategy",
  publishedDate: "2026-03-21",
  relatedSlugs: ["loi-checklist-provisions", "security-deposit-negotiation", "restaurant-loi-redlining"],
  faqs: [
    {
      question: "Should landlords waive the security deposit for national credit tenants?",
      answer: "It is common to waive or reduce the security deposit to one month's rent for investment-grade national credit tenants because the corporate entity's balance sheet serves as the guarantee. However, the deposit waiver should be conditioned on the tenant maintaining its credit rating. Include language that reinstates the deposit requirement if the tenant's credit rating falls below investment grade. This protects you in the event of a corporate downgrade or restructuring."
    },
    {
      question: "How should landlords evaluate a franchise operator differently from the franchisor brand?",
      answer: "The franchisee is your tenant, not the brand. A location operating under a nationally recognized fast-food brand may be owned by a single individual or a small LLC with limited assets. Request the franchisee's entity financials, personal financial statements of the principals, the franchise agreement to verify it is in good standing, and the franchisee's operating history including how many locations they operate. A franchisee running 25 locations with a 15-year track record is a fundamentally different credit risk than a first-time franchisee opening their first unit."
    }
  ],
  content: `## Defining National Credit Tenants
...
For a [national credit tenant](/glossary#security-deposit), the [security deposit](/blog/security-deposit-negotiation) conversation is entirely different than it is for a local operator. Credit tenants routinely request that the security deposit be waived entirely, and in many markets, this is standard. The logic is straightforward: if the tenant is a publicly traded company with $5B in annual revenue and an investment-grade rating, holding $15,000 in a deposit account adds no meaningful protection. The corporate guarantee is worth infinitely more than any deposit amount a landlord would reasonably require.
...
Treat franchise operators as local tenants from a credit evaluation standpoint, regardless of the brand on the sign. Require personal guaranties, full security deposits, and tighter assignment controls. For more on restaurant-specific provisions, see our [restaurant LOI guide](/blog/restaurant-loi-redlining).
